...
export default function AsideSwiper() {
   return (
      <div className="max-w-[400px] h-96 bg-gray-300">
         <Swiper
         ...
         >
            <SwiperSlide>
               <div className="h-full flex flex-col gap-16 p-6 text-white bg-primary/30 ">
                  ...
                  <span className="text-xl">September 17, 2018 - Tips & Tricks</span>
                  <h4 className="text-3xl font-bold leading-12">Finding Love & home in Tbilisi, Georgia</h4>
               </div>
            </SwiperSlide>
            <SwiperSlide>
               <div className="h-full flex flex-col gap-16 p-6 text-white bg-primary/30 ">
